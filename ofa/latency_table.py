...
class LatencyTable:
    def __init__(self, table_path ='lookup_table.yaml'):
        self.latency_tables = {}
        self.latency_tables = LatencyEstimator('lookup_table.yaml')
        print("--------------Lookup table is Loaded------------")
